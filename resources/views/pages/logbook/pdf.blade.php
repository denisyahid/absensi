...
$no = 1;
                                ...
                                <div class="flex justify-end">
                                    ...
                                    <div class="w-[400px] mt-6 text-center">
                                        <input value="@php Carbon\Carbon::setLocale('id'); echo "Garut, " . Carbon\Carbon::now()->translatedFormat('d F Y');@endphp" type="text" id="tanggalInput" class="w-full font-bold text-center border-none outline-none focus:outline-none ring-none">
                                        <p class="font-semibold">Mengetahui,</p>

                                        <!-- ===== BAGIAN TANDA TANGAN YANG DIUBAH ===== -->
                                        <!-- Dropdown pilihan pejabat -->
                                        <select id="pejabatSelect" style=" appearance: none;
    -webkit-appearance: none;
    -moz-appearance: none; " class="w-full appearance-none only-screen  p-1 text-md border-none text-center rounded outline-none">
                               ...
                               <div>
                                        ...
                                        id="printButton" onclick="hideAndPrint()">refresh hla , tras pilih jabatan , Print , Supados tereh cair ... wkwk</button>
    ...
    <script>
        ...
        // Pastikan elemen sudah tersedia
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Jika elemen ditemukan, pasang event listener
            if (select && jabatanInput && namaInput && nipInput) {
                ...
                // (Opsional) Trigger change untuk menyelaraskan default jika perlu
