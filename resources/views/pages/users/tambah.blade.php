            ...
            <section class="bg-white dark:bg-gray-900">
                <div class="container flex items-center justify-center min-h-screen px-6 mx-auto">
                    <form wire:submit="simpan" class="w-full max-w-lg">
                        ...
                        @if ($foto)
                            <img src="{{ $foto->temporaryUrl() }}" class="object-cover border-2 rounded-full w-52 h-52"
                                alt="">
                        @endif
                        @error('foto')
                            <span class="mt-2 text-xs text-red-500 error">{{ $message }}</span>
                        ...
                        <div class="relative flex items-center mt-6">
                            ...
                            <select
                                class="block w-full py-3 text-gray-700 bg-white border rounded-lg px-11 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40"
                                wire:model="jabatan" id="jabatan" class="block w-full mt-1" type="jabatan" name="jabatan"
